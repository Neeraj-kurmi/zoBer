          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <Input
                ...
                className="focus-visible:ring-offset-0 focus-visible:ring-0 my-1 border-gray-200 shadow-lg rounded-md"
              />
            </div>
            <div>
            ...
            <div>
              ...
              <Input
                ...
                value={input.salary}
                onChange={changeEventHandler}
                className="focus-visible:ring-offset-0 focus-visible:ring-0 my-1border-gray-200 shadow-lg rounded-md"
              />
            </div>
            <div>
